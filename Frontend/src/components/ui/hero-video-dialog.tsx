...
export default function HeroVideoDialog({
    ...
    className,
    children,
}: HeroVideoProps & { children?: React.ReactNode }) {
            ...
            <AnimatePresence>
                {isVideoOpen && (
                    ...
                    >
                        ...
                        >
                            <motion.button className="absolute -top-16 right-0 rounded-full bg-neutral-900/50 p-2 text-xl text-white ring-1 ring-neutral-900/20" onClick={() => setIsVideoOpen(false)}>
                                <X className="h-5 w-5" />
                            </motion.button>
