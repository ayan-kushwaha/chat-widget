    ...
    return (
        <motion.button
            ...
            className={cn(
                ...
                "bg-gradient-to-br from-black to-neutral-600 text-white dark:from-zinc-900 dark:to-zinc-900",
                "disabled:cursor-not-allowed disabled:opacity-50",
                className,
            )}
        >
            <span
                className="relative block h-full w-full text-sm uppercase tracking-wide dark:font-light dark:text-white"
                style={{
                    maskImage:
